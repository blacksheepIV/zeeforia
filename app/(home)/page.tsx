  ...
  return (
    <main id="home" className="relative h-full min-h-screen overflow-hidden">
      ...
      <div className="absolute top-[120px] left-8 flex flex-col items-start justify-center">
        <h1 className="sm:text-4xl md:text-6xl font-bold text-delft_blue-100 animate-slide-in-left">
          Zeef Oria
        </h1>
        <p className="sm:text-lg md:text-xl text-orange-700 animate-slide-in-left mt-5 ">
